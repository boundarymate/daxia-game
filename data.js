...
// ─────────────────────────────────────────────
TRAITS: [
  { id:'t_strong',    name:'天生神力',  desc:'生来力大无穷，习练外功事半功倍',
    bonus:{ strength:15, endurance:8 } },
  { id:'t_agile',     name:'身轻如燕',  desc:'骨骼轻盈，天生适合轻功身法',
    bonus:{ agility:15, speed:8 } },
  { id:'t_smart',     name:'聪慧过人',  desc:'悟性极高，学武功如有神助',
    bonus:{ perception:15, luck:5 } },
  { id:'t_handsome',  name:'相貌堂堂',  desc:'仪表不凡，初见便令人心生好感',
    bonus:{ charm:18, reputation:5 } },
  { id:'t_tough',     name:'铁骨铮铮',  desc:'体魄强健，气血充沛',
    bonus:{ hp:30, endurance:12 } },
  { id:'t_inner',     name:'内功根基',  desc:'天生内力充沛，修炼内功进境极快',
    bonus:{ innerPower:20, perception:5 } },
  { id:'t_sword',     name:'剑道天赋',  desc:'与剑有缘，习剑法如鱼得水',
    bonus:{ swordSkill:15, agility:5 } },
  { id:'t_cruel',     name:'心狠手辣',  desc:'行事果决，不留余地，邪道加成',
    bonus:{ strength:10, evil:10, charm:-5 } },
  { id:'t_kind',      name:'悲天悯人',  desc:'心怀苍生，正道加成，易获民心',
    bonus:{ morality:15, reputation:10, charm:8 } },
  { id:'t_lucky',     name:'鸿运当头',  desc:'天生好运，奇遇频发',
    bonus:{ luck:20 } },
  { id:'t_stubborn',  name:'坚韧不拔',  desc:'意志如铁，修炼不辍',
    bonus:{ endurance:15, innerPower:8 } },
  { id:'t_poison',    name:'百毒不侵',  desc:'天生对毒素有抵抗力',
    bonus:{ endurance:10, hp:15, luck:5 } },
  { id:'t_memory',    name:'过目不忘',  desc:'见过的武功招式过目不忘',
    bonus:{ perception:20, luck:5 } },
  { id:'t_cold',      name:'冷若冰霜',  desc:'不苟言笑，令人敬畏',
    bonus:{ strength:8, evil:5, charm:-8, reputation:5 } },
  { id:'t_wine',      name:'嗜酒如命',  desc:'酒后武功大进，但消耗金钱',
    bonus:{ strength:12, innerPower:10, gold:-20 } },
],
...
// ─────────────────────────────────────────────
BACKGROUNDS: [
  { id:'b_noble',     name:'书香门第',  desc:'出身书香世家，见识广博，初始金钱较多',
    bonus:{ gold:80, perception:10, charm:5 } },
  { id:'b_poor',      name:'贫苦出身',  desc:'自幼贫苦，磨砺出坚韧意志',
    bonus:{ endurance:15, strength:8, gold:-30 } },
  { id:'b_jianghu',   name:'江湖遗孤',  desc:'父母皆为江湖人，自幼耳濡目染',
    bonus:{ swordSkill:10, reputation:15, gold:20 } },
  { id:'b_military',  name:'将门之后',  desc:'出身军旅世家，习得基础兵法',
    bonus:{ strength:12, endurance:10, gold:40 } },
  { id:'b_merchant',  name:'商贾之家',  desc:'家境殷实，初始金钱丰厚',
    bonus:{ gold:120, charm:8, luck:5 } },
  { id:'b_monk',      name:'寺庙出身',  desc:'自幼在寺庙长大，内功根基扎实',
    bonus:{ innerPower:20, morality:10, gold:-10 } },
  { id:'b_thief',     name:'绿林出身',  desc:'曾混迹绿林，身手敏捷，消息灵通',
    bonus:{ agility:12, luck:10, evil:5, gold:30 } },
  { id:'b_official',  name:'官宦之后',  desc:'父辈为官，人脉广泛',
    bonus:{ charm:12, gold:60, reputation:10 } },
  { id:'b_nomad',     name:'塞外游侠',  desc:'来自塞外，体魄强健，骑术精湛',
    bonus:{ strength:15, endurance:12, agility:8 } },
  { id:'b_doctor',    name:'医家子弟',  desc:'自幼习医，懂得疗伤之术',
    bonus:{ hp:20, endurance:10, gold:20 } },
],
